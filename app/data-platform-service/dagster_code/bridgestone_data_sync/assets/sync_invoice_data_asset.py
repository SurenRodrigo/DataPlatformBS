...
def sync_invoice_data(context: AssetExecutionContext):
    """
    Dagster asset to sync invoice data from Excel file to Azure SQL Database invoice_data table.
    ...
    """
    context.log.info("Starting Bridgestone invoice data sync from Excel to Azure SQL Database...")
    ...
    try:
        ...
        excel_path = "/app/external_files/StaticMasterDataSet-Factura.xlsx"
        sheet_name = "Faktura_values"
        
        # Database configuration
        schema_name = "pyairbyte_cache"
        table_name = "invoice_data_2026"
