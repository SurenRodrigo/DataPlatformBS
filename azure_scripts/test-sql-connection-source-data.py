...
print("=" * 60)
print("Testing Service Principal Connection to Azure SQL Database (source_data)")
print("=" * 60)
...
try:
    ...
    print("=" * 60)
    print("✓ All tests passed! Service Principal connection to source_data is working.")
    print("=" * 60)
    ...
    print("1. Verify the SQL script (setup-sql-service-principal-source-data.sql) was executed successfully")
    ...
    print("4. Verify the credentials in .env file are correct (AZURE_SOURCE_DATA_*)")
    sys.exit(1)
except Exception as e:
