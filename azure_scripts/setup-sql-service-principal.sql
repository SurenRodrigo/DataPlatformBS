...
-- Display Name: Gture Brigestone dataplatform
...
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = 'Gture Brigestone dataplatform')
BEGIN
    CREATE USER [Gture Brigestone dataplatform] FROM EXTERNAL PROVIDER;
...
WHERE name = 'Gture Brigestone dataplatform';
GO
...
WHERE dp.name = 'Gture Brigestone dataplatform';
GO
